...
data class Classic  (
    override var maxFieldsPerTable : Int = 50,
    override var maxTablesPerDatabase : Int = 200,
    override var maxFieldsPerUdt : Int = 30,
    override var maxSecondaryIndexesPerTable : Int = 1,
    override var maxMaterializedViewsPerTable : Int = 2,
    override var maxSaiPerTable : Int = 10,
    override var maxSaiPerDatabase : Int = 100,
