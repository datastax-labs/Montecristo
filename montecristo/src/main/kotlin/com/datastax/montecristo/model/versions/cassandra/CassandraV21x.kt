...
class CassandraV21x (versionIdentifier: String) : Cassandra(versionIdentifier)  {
    ...
    override fun latestRelease(): DatabaseVersion {
        return DatabaseVersion.latest21()
    }
    ...
    override fun recommendedOSSettingsLink(): String {
        return "https://docs.datastax.com/en/cassandra-oss/2.1/cassandra/install/installRecommendSettings.html"
    }
}